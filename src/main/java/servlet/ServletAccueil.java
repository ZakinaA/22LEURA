...
public class ServletAccueil extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("servleraccueil url="+url);

        //Affichage de tous les groupes sur la page d'accueil
        if(url.equals("/normanzik/ServletAccueil/index")){
             System.out.println("servleraccueil ACCUEIL");
